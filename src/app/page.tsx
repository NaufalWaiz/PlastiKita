  ...
  return (
    ...
    {/** First Section */}
      <section className="min-h-screen bg-none text-black pt-14 px-3 sm:px-12 sm:pt-36 font-poppins" id="beranda">
        ...
        <div className="group w-fit flex flex-row items-center gap-5 transform transition bg-transparent hover:bg-[#88A825] rounded-full">
            <div className="flex bg-[#88A825] w-10 h-10 justify-center items-center rounded-full">
                ...
                <FontAwesomeIcon icon={faArrowRight} className="text-white pointer-events-none absolute transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:translate-x-1"/>
            </div>
            <span className="group-hover:text-white text-[#88A825] font-semibold text-[18px] transition-colors mr-5">Jelajahi Sekarang</span>
        </div>
