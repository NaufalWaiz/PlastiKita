      ...
      <>
        <section className="min-h-[80vh] pt-48 text-black">
          <div className="w-full flex flex-col items-center font-poppins font-[600]">
            ...
            <p className="text-[16px] sm:text-[32px]">Yuk simak halaman ini</p>
          </div>
        </section>
        <section className="min-h-[170vh] bg-tentang bg-cover bg-center relative">
          ...
          <div className="absolute w-10/12 bg-linear-to-b px-5 sm:px-32 py-10 sm:py-24 z-10 rounded-tr-[60px] rounded-bl-[60px] from-[#2F4F12] to-[#65853D] -bottom-10 sm:-bottom-72 left-1/2 -translate-x-1/2">
            ...
            <p className="font-poppins font-[500] text-center mx-auto italic text-[20px] sm:text-[24px] w-full sm:w-10/12">
        ...
        <section className="min-h-screen xl:min-h-[200vh] bg-[#f7e7c4]">
          <div className=" bg-trash-doodle bg-cover bg-center lg:h-screen relative">
          ...
          <div className=" bg-trash-doodle bg-cover bg-center min-h-screen pt-8 pb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-14 sm:gap-10 w-full items-center justify-center">
                <div className="w-10/12 sm:w-5/12 h-[552px] rounded-[50px] bg-produksi-sampah bg-cover bg-center relative">
                    <div className="bg-[#3B3B0E] rounded-t-[20px] w-6/12 px-2 py-4 absolute -top-12 left-1/2 -translate-x-1/2">
                        <h1 className="font-poppins text-white font-[500] text-24px text-center">Produksi & Sampah Plastik Indonesia (2024)</h1>
                    </div>
                </div>
                <div className="w-10/12 sm:w-5/12 h-[552px] rounded-[50px] bg-sampah-gorontalo bg-cover bg-center relative">
                    <div className="bg-[#3B3B0E] rounded-t-[20px] w-6/12 px-2 py-4 absolute -top-12 left-1/2 -translate-x-1/2">
                        <h1 className="font-poppins text-white font-[500] text-24px text-center">Komposisi Polusi Plastik di Indonesia (2023)</h1>
                    </div>
                </div>
            </div>
          </div>
